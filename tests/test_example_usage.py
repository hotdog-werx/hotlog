...
@pytest.mark.parametrize(
    ...
    [
        ...
        level_0(
            ...
            desc='warnings_shown,_debug_hidden_at_level_0',
        ),
        level_1(
            'Processing data',
            'source: database.db',
            ...
            desc='verbose_context_visible,_debug_hidden_at_level_1',
        ),
        level_2(
            'Analyzing results',
            'processing_time: 0.5s',
            ...
            'queue_size: 12',
            'thread_pool: active',
            desc='debug_context_and_messages_visible_at_level_2',
        ),
        level_0(
            'Example completed',
            ...
            'duration: 2.3s',
            'items_processed: 100',
            desc='completion_messages_shown',
        ),
    ],
